...
site.render((0, _models.model));
const sidebar = new (0, _sidebar.SideBar)("#panel");

},{"./models":"cHn7K","./styles/main.css":"clPKd","./classes/site":"24VTm","./classes/sidebar":"5YCBk"}],"cHn7K":[function(require,module,exports) {
...
const model = [
    new (0, _block.TitleBlock)("Hello World from JS!", {
        tag: "h1",
    ...
    new (0, _block.ParagraphBlock)("Some text has arrived here", {
        styles: {
            color: "#333333",
    ...
    new (0, _block.ImageBlock)((0, _imgJpgDefault.default), {
        alt: "\u0417\u0434\u0435\u0441\u044C \u043A\u0430\u0440\u0442\u0438\u043D\u043A\u0430",
        styles: {
            width: "1000px",
            height: "auto"
...
},{"./images/img.jpg":"3yhft","./classes/block":"3AZe8","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3yhft":[function(require,module,exports) {
module.exports = require("./helpers/bundle-url").getBundleURL("bLxZJ") + "img.e1c7c74c.jpg" + "?" + Date.now();
...
class TitleBlock extends Block {
    ...
    toHTML() {
        ...
        return (0, _utils.row)((0, _utils.col)(`<${tag} class="header" style="${(0, _utils.toCSS)(styles)}">${this.value}</${tag}>`));
    }
}
class ParagraphBlock extends Block {
    ...
    toHTML() {
        ...
        return (0, _utils.row)((0, _utils.col)(`<p class="paragraph" style="${(0, _utils.toCSS)(styles)}">${this.value}</p>`));
    }
}
class ColumnsBlock extends Block {
    ...
    toHTML() {
        const styles = this.options.styles;
        const html = this.value.map((item)=>(0, _utils.col)(item, styles)) // Аналогично .map(item => col(item))
        ;
        // Получили map и соединяем его элементы с помощью join(), избавляясь от запятых при автоматическом преобразовании в строку
        return (0, _utils.row)(`<p>${html.join("")}</p>`);
    }
}
class ImageBlock extends Block {
    ...
    toHTML() {
        ...
        return (0, _utils.row)(`<img alt="${alt}" src="${this.value}" style="${(0, _utils.toCSS)(styles)}"/>`, divStyles);
    }
}
class TextBlock extends Block {
    ...
    toHTML() {
        ...
        return (0, _utils.row)(`<p style="${(0, _utils.toCSS)(styles)}">${this.value}</p>`, divStyles);
    }
}
...
},{}],"clPKd":[function() {},{}],"24VTm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class SideBar {
    ...
    get template() {
        return [
            (0, _utils.sideBlock)("\u0417\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A"),
            (0, _utils.sideBlock)("\u041F\u043E\u0434\u0437\u0430\u0433\u043E\u043B\u043E\u0432\u043E\u043A")
        ].join("");
    }
    add(event) {
...
},{"../utils":"en4he","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ShInH","8lqZg"], "8lqZg", "parcelRequire5634")
